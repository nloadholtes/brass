#! /usr/bin/env python
"""Word-wrapped text display module

This module contains one function: render_textrect, which will try to return a
surface containing the supplied string, word-wrapped as necessary to fit within
the supplied rectstyle object. The function can also left or right justify, or
center the supplied text. It will raise a TextRectException if the string won't
fit into the rect's area.

Tries to render the supplied text string in the passed rect, by word-wrapping
where possible.  Interprets an embedded \n as a linefeed.  Displays the final
text left or right justified, or centered.
"""
